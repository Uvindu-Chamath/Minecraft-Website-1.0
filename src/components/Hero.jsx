...
export default function Hero({ onBuyKey, onBuyAccount }) {
  return (
    <section id="hero" className="relative pt-24 pb-12 lg:pt-32 lg:pb-16 overflow-hidden flex flex-col items-center justify-center text-center px-6">
      ...
      >
        ...
        <motion.div 
          ...
          className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full glass border-white/5 text-xs font-semibold tracking-wide mb-6 shadow-sm"
        >
        ...
        <motion.h1 
          variants={childVariants}
          className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight text-white mb-4 leading-[1.1] font-sans"
        >
        ...
        <motion.p 
          variants={childVariants}
          className="text-base sm:text-lg md:text-xl text-neutral-400 mb-6 max-w-2xl mx-auto leading-relaxed"
        >
        ...
        <motion.div 
          variants={childVariants}
          className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-6 max-w-md sm:max-w-none mx-auto w-full px-4"
        >
        ...
        <motion.div 
          variants={childVariants}
          className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2.5 text-sm text-neutral-500"
        >
          ...
          <span className="flex items-center gap-1.5">
            ...
            Only <strong className="text-neutral-300"><AnimatedCounter value={223} /> keys</strong> remaining in stock
          </span>
        </motion.div>
      </motion.div>
    </section>
